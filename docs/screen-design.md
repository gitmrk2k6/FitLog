...
| SC-03 | ダッシュボード | 必要 | F-07,F-08,F-09 | 達成率リング・ストリーク・ヒートマップ・直近PR |
...
+----------------------------------------------------------+
|  直近の自己ベスト更新                                    |
|  ・ベンチプレス 80kg×5 (推定1RM 93kg)  2026-05-17        |
|  ・スクワット  100kg×3                  2026-05-15        |
+----------------------------------------------------------+
|  [ 今日の記録をつける → SC-04 ]                          |
+----------------------------------------------------------+
```

- 表示項目: 達成率リング(F-07)、ストリーク現在/最長(F-08)、ヒートマップ(F-08)、直近PR(F-09)
